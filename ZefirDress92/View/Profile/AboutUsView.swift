    ...
    var body: some View {
        ...
        ScrollView {
            ...
            VStack(alignment: .leading){
                Text("**Zefir Dress** - сервис проката вечерних платьев для фотосессий и мероприятий. Вы можете арендовать у нас платье для любого повода - выпускной, бал, свадьба подруги, свидание, фотосессия, вечеринка, корпоратив, фотосессия беременности и день рождение.")
                ...
                Text("Мы являемся сервисом по аренде платьев и работаем в режиме доставки платьев [💞] Вы можете выбрать до 10 платьев и мы привезём Вам их на примерку домой. Вы их самостоятельно меряете и затем выносите (время до 30 минут на примерку), услуга бесплатная.")
                    .foregroundColor(colorFont)
                    .font(.custom(mediumFont, size: fontSizeMedium))
                    .padding([.leading, .trailing, .bottom])
